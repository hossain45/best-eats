...
const Login = () => {
  return (
    <div className="my-5 sm:my-10 md:my-20 mx-auto relative flex w-96 flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
  ...
  <div className="flex flex-col gap-4 p-6">
    <div className="relative h-11 w-full min-w-[200px]">
      <input
        className="peer h-full w-full rounded-md border border-blue-gray-200 border-t-transparent bg-transparent px-3 py-3 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:pl-12 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-orange-500 focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50 duration-200 focus:placeholder-shown:pl-2 focus:placeholder-shown:opacity-100"
        placeholder="besteats@example.com"
