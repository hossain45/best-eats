            ...
            <div className="flex gap-3 items-center">
              ...
              <div>
                ...
                <div className="flex justify-center items-center">
                  ...
                  <button onClick={() => handleDelete(cartItem.id)} className=" hover:bg-slate-100 ">
                    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 30 30"  className="block m-0 p-0">
